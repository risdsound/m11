...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 99.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 373.0, 65.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.0, 306.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 361.0, 350.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 334.0, 137.0, 22.0, 140.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 393.0, 420.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 275.285126, 373.959991, 47.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 483.421478, 49.580002, 111.0, 19.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 3.0, 116.0, 92.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 74.0, 20.0, 19.0 ],
					"style" : "",
					"text" : "1.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 56.0, 53.0, 19.0 ],
					"style" : "",
					"text" : "distance"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 56.0, 57.0, 19.0 ],
					"style" : "",
					"text" : "elevation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 56.0, 52.0, 19.0 ],
					"style" : "",
					"text" : "azimuth"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 100.0, 75.0, 61.0, 21.0 ],
					"style" : "",
					"varname" : "azi[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 164.0, 75.0, 61.0, 21.0 ],
					"style" : "",
					"varname" : "ele[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 75.0, 61.0, 21.0 ],
					"style" : "",
					"varname" : "dist[1]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.785126, 469.519989, 176.5, 21.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"aed_scale" : 10.0,
						"center_att_db" : 6.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 573.0, 70.100006, 18.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 25,
					"numoutlets" : 0,
					"patching_rect" : [ 65.142265, 661.47998, 385.0, 21.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 483.421478, 70.100006, 86.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 114.0, 125.0, 150.0, 230.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 483.421478, 99.5, 288.0, 437.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 119.785126, 505.519989, 271.0, 21.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.314056, 36.0, 102.0, 19.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 123.5, 415.679993, 130.285126, 415.679993 ],
					"source" : [ "obj-113", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 109.5, 96.0, 12.5, 96.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 173.5, 96.0, 49.0, 96.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 237.5, 96.0, 85.5, 96.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 582.5, 90.5, 571.490356, 90.5, 571.490356, 70.100006, 492.921478, 70.100006 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 12.5, 137.0, 101.157028, 137.0, 101.157028, 121.839996, 123.5, 121.839996 ],
					"source" : [ "obj-63", 0 ]
				}
